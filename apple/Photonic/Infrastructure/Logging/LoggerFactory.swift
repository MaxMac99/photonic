...
extension Logger {
    ...
    func error(_ message: String, error: Error? = nil, file: String = #file, function: String = #function, line: Int = #line) {
        ...
        if let error = error {
            ...
            self.error("\(message, privacy: .public) - Error: \(error.localizedDescription, privacy: .public) [File: \(file, privacy: .public), Function: \(function, privacy: .public), Line: \(line, privacy: .public)]")
        } else {
            logMessage = message
            self.error("\(message, privacy: .public) [File: \(file, privacy: .public), Function: \(function, privacy: .public), Line: \(line, privacy: .public)]")
        }
        #if DEBUG
    ...
    func warning(_ message: String, file: String = #file, function: String = #function, line: Int = #line) {
        self.warning("\(message, privacy: .public) [File: \(file, privacy: .public), Function: \(function, privacy: .public), Line: \(line, privacy: .public)]")
        #if DEBUG
        let fileName = (file as NSString).lastPathComponent
    ...
    func debug(_ message: String, file: String = #file, function: String = #function, line: Int = #line) {
        #if DEBUG
        self.debug("\(message, privacy: .public) [File: \(file, privacy: .public), Function: \(function, privacy: .public), Line: \(line, privacy: .public)]")
        let fileName = (file as NSString).lastPathComponent
    ...
    func verbose(_ message: String, file: String = #file, function: String = #function, line: Int = #line) {
        #if DEBUG
        self.trace("\(message, privacy: .public) [File: \(file, privacy: .public), Function: \(function, privacy: .public), Line: \(line, privacy: .public)]")
        let fileName = (file as NSString).lastPathComponent
    ...
    func logSensitive(_ message: String, sensitiveData: String? = nil) {
        if let sensitiveData = sensitiveData {
            self.info("Operation: \(message, privacy: .public) - Data: \(sensitiveData, privacy: .sensitive(mask: .hash))")
        } else {
            self.info("\(message, privacy: .public)")
        }
    }
