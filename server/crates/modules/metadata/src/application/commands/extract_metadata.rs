...
use derive_new::new;
use kernel::{app_error::ApplicationResult, FileLocation, MediumId, MediumItemId, UserId};
use tracing::{error, info};

use crate::{
    application::ports::{MetadataExtractor, MetadataRepository, PublishMetadataEvent},
    domain::Metadata,
};
