...
use derive_new::new;
use kernel::{app_error::ApplicationResult, error::EntityNotFoundSnafu, MediumId, UserId};
use snafu::OptionExt;
use tracing::{debug, warn};

use crate::{
    application::ports::{MediumRepository, PublishMediumEvent},
    domain::camera::GpsCoordinates,
};
