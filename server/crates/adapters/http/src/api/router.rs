...
use crate::{api::state::AppState, auth::setup_auth, settings::AuthSettings};
...
pub async fn create_router_with_api(
    ...
    Ok(OpenApiRouter::with_openapi(ApiDoc::openapi())
        .nest(
            "/api/v1/medium",
            medium::router(state.clone(), authorization.clone()),
        )
        // .nest(
        //     "/api/v1/album",
        //     album::api::router(state.clone(), authorization.clone()),
        // )
        // .nest(
        //     "/api/v1/user",
        //     user::api::router(state.clone(), authorization.clone()),
        // )
...
pub fn create_api() -> utoipa::openapi::OpenApi {
    OpenApiRouter::with_openapi(ApiDoc::openapi())
        .nest("/api/v1/medium", medium::routes())
        // .nest(
        //     "/api/v1/album",
        //     album::api::router(),
        // )
