use medium::domain::{MediumItemType, MediumType, ThumbnailVariant};
...
/// Thumbnail size variants generated by the client (issue #1).
...
impl From<ThumbnailVariant> for ThumbnailVariantDto {
    fn from(variant: ThumbnailVariant) -> Self {
        match variant {
            ThumbnailVariant::Tiny => ThumbnailVariantDto::Tiny,
            ThumbnailVariant::Small => ThumbnailVariantDto::Small,
            ThumbnailVariant::Large => ThumbnailVariantDto::Large,
        }
    }
}

impl From<ThumbnailVariantDto> for ThumbnailVariant {
    fn from(dto: ThumbnailVariantDto) -> Self {
        match dto {
            ThumbnailVariantDto::Tiny => ThumbnailVariant::Tiny,
            ThumbnailVariantDto::Small => ThumbnailVariant::Small,
            ThumbnailVariantDto::Large => ThumbnailVariant::Large,
        }
    }
}
