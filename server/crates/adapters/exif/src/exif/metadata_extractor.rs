...
use kernel::{error::DomainResult, FileLocation, MediumId};
use medium::application::ports::FileStorage;
use metadata::{
    application::ports::MetadataExtractor,
    domain::{CameraInfo, FileInfo, LocationInfo, Metadata, Orientation, TechnicalInfo},
};
use uuid::Uuid;
