...
use medium::domain::events::TempCleanupFailedEvent;
use metadata::domain::events::MetadataExtractionFailedEvent;
use task::{
    application::commands::{FailTaskCommand, FailTaskHandler},
    domain::TaskType,
};
